...
class _HeightScreenState extends State<HeightScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<OnBoardingBloc, OnBoardingState>(
        condition: (_, current) =>
            current is NeedToValidateState &&
            current.index == widget.screenIndex,
        listener: (context, state) {
          ...
          print(
              "_HeightScreenState.build: Height data is ${isValid ? 'valid' : 'invalid'}");
        },
                        ...
                        child: CustomNumberFormField(
                          ...
                          onSaved: (newValue) {
                            context
                                ...
                                .add(ChangeHeight(int.parse(newValue)));
                            try {
